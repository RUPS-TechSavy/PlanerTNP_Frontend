...
const TermsOfService = () => {
  ...
  <div className="privacy-container">
    <h1>PlanWise Terms and Conditions</h1>
    <p>Please read these terms and conditions carefully before using https://www.planwise.com website operated by teams TeachSavy and PlanWise.</p>
